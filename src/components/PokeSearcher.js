...
const PokeSearcher = ({
  ...
  return (
    <div className="poke-searcher">
      ...
      <br/>
      <p>
         Try to search by specific Color!
      </p> 
      <div className="color-btns">
        ...
        <br/>
      <p>
         Try to search by specific Gender!
      </p> 
      <div className="gender-btns">
          <button className="gender-male" onClick={() => handleGender("male")}>
          MALE
          </button>
          <button className="gender-female" onClick={() => handleGender("female")}>
          FEMALE
          </button>
          <button className="gender-undefined" onClick={() => handleGender("genderless")}>
          UNDEFINED
          </button>
      </div>
    </div>
